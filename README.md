...
3. Edit the variables in the dsc_download.sas macro.
   ...
   | DSC_LOAD_START_DTTM    | (Optional) The start value in this format: `%nrquote(ddMMMYYYY HH:mm:ss)`. For example: `%nrquote(12Jan2020 13:00:00)`<br><br>**Note:** To download the data for the entire day (that is, starting at 12:00 AM), make sure that the digits for minutes and seconds are zeros.                                                                                 |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          
